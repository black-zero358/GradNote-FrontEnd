 ...
 * @param {string} props.imageUrl - 题目图片URL (可能是blob URL)
 * @param {string} props.backendImagePath - 后端图片路径
 * @param {string} props.questionText - 题目文本
 * @param {number} props.rowNumber - 行号
 * @returns {JSX.Element}
 */
const QuestionPreview = ({ imageUrl, backendImagePath, questionText, rowNumber }) => {
  // 初始化状态
  ...
  return (
    <PreviewContainer title={`题目信息 (${rowNumber})`}>
      <ImageContainer>
